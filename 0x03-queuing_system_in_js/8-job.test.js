...
beforeEach(function () { queue.testMode.clear(); });
after(function () { queue.testMode.exit(); });

describe('createPushNotificationsJobs', function () {
  it('jobs must be an array', function () {
    createPushNotificationsJobs(jobs, queue);
    expect(queue.testMode.jobs.length).to.equal(9);
  });
});
...
//     const job = queue.create('push_notification_code_2', task)
